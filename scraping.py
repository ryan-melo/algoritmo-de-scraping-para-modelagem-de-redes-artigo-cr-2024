...
datas = ['2010-01-04', '2010-01-11', '2010-01-18', '2010-01-25',
...
with open('ranking_musicas.txt', 'w', encoding='utf-8') as file:
    for data in dados:
...
print("Dados escritos no arquivo 'ranking_musicas.txt'.")